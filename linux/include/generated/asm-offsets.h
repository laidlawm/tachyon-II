...
#define TASK_THREAD_RA 2136 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 2144 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 2152 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 2160 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 2168 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 2176 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 2184 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 2192 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 2200 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 2208 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 2216 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 2224 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 2232 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 2240 /* offsetof(struct task_struct, thread.s[11]) */
#define TASK_THREAD_SP 2144 /* offsetof(struct task_struct, thread.sp) */
...
#define TASK_THREAD_F0 2248 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 2256 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 2264 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 2272 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 2280 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 2288 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 2296 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 2304 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 2312 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 2320 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 2328 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 2336 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 2344 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 2352 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 2360 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 2368 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 2376 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 2384 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 2392 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 2400 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 2408 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 2416 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 2424 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 2432 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 2440 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 2448 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 2456 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 2464 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 2472 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 2480 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 2488 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 2496 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 2504 /* offsetof(struct task_struct, thread.fstate.fcsr) */
